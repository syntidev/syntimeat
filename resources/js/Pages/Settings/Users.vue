...
const page      = usePage()
const isAnalyst = computed(() => page.props.auth?.user?.role === 'analyst')
            ...
            <div class="settings-panel__header">
                <div class="header-row">
                    ...
                    <div class="header-actions">
                        ...
                        <button v-if="!isAnalyst" class="btn-primary" @click="openNew">+ Agregar usuario</button>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        <tr v-for="u in users" :key="u.id">
                            ...
                            <td class="td-actions">
                                ...
                                <button v-if="!isAnalyst" class="icon-action icon-action--danger" @click="destroy(u)" title="Eliminar">
